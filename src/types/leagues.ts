...
export const EventPointsZod = z.coerce
  .number()
  .int()
...
export const BaseEventRulesZod = z.object(
  ...
  'strip',
  z.ZodTypeAny,
  Record<ScoringBaseEventName, number>,
  Record<ScoringBaseEventName, number>
>;
...
export const ShauhinModeSettingsZod = z
  .object({
    enabled: z.boolean(),
...
export const CustomEventRuleInsertZod = z
  .object({
...
export type DraftDetails = Record<
  ...
  {
    tribe: Tribe;
    castaways: { castaway: EnrichedCastaway; member: LeagueMember | null }[];
  }
>;
