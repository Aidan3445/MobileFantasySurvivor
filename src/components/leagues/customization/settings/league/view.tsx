...
export function LeagueSettings() {
  ...
  return (
    <View className='w-max rounded-xl bg-card p-2'>
      <Text className='text-card-foreground mb-4 text-center text-lg font-bold'>
        Edit League Details
      </Text>

      <View className='mb-4'>
        <Text className='text-card-foreground mb-2 text-lg'>League Name</Text>
        <Controller
      ...
      <View className='mb-6'>
        <Text className='text-card-foreground mb-2 text-lg'>League Admins</Text>
        <Button
          className='w-full rounded-lg border border-primary p-3'
          onPress={adminsModal.openModal}>
          <Text className='text-card-foreground text-left text-lg'>
